...
import './HelloStroke.css';

export default function HelloStroke() {
  const safeId = useId().replace(/[^a-zA-Z0-9_-]/g, '');
  const gradientId = `hello-gradient-${safeId}`;

  return (
    <span className="hello-stroke">
      <svg
        className="hello-stroke__svg"
        viewBox="0 0 638 200"
        fill="none"
        strokeLinecap="round"
      ...
      >
        <defs>
          ...
          >
            ...
            <stop offset="42%" style={{ stopColor: 'var(--accent)' }} />
            <stop offset="100%" style={{ stopColor: 'var(--accent-2)' }} />
          </linearGradient>
        </defs>
        <path
          className="hello-stroke__path hello-stroke__path--first"
        ...
        />
        <path
          className="hello-stroke__path hello-stroke__path--second"
