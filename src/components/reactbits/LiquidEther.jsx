...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Dark mode keeps the page tint (not pure black) as the low-energy fallback
    // so fluid edges stay luminous instead of muddying toward black.
    const bgVec4 = new THREE.Vector4(bg.r, bg.g, bg.b, lightMode ? 1 : 0);
...
`;
  ...
  useEffect(() => {
    ...
    if (webgl) webgl.props = { ...webgl.props, maxFPS };
  }, [maxFPS]);
